...
if __name__ == "__main__":
    ...
    av = AlphaVantage()
    # Download the Google OHLCV data from 1/1/2005 to 1/1/2013
    start_date = dt(2005, 1, 1)
    end_date = dt(2013, 1, 1)

    # Create a dataframe of AlphaBet (Google) stock price based on AlphaVantage data
    goog = av.get_daily_historic_data('GOOGL', start_date, end_date)
    # Create a dataframe of S&P ETF stock price based on AlphaVantage data
